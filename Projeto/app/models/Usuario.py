...
class Usuario(db.Model):
    ...
    #foto_perfil = Column(String, default="default.png")
    ...
    def __init__(self, cpf, nome, telefone, email, senha, data_nascimento, foto_perfil = None):
        ...
        self.email = email #ver questão de intregridade, já que ele é PK
    ...
    #Altera a informação de seu perfil

    def alterarFotoPerfil(self, fotoNova):
        #se tem foto de perfil já
        if self.foto_perfil:
            self.foto_perfil.update()
        else:
    ...
    def alterarPerfil(nomeNovo, emailNovol, data_nascimentoNova):
